...
class TestErasurePropagationBody:
    def test_propagation_body_creation(self):
        ...
        body = ErasurePropagationStatusBody(
            ...
            downstream_agents=["agent://sub1.com", "agent://sub2.com"],
        )
    ...
    def test_downstream_agents(self):
        ...
        agents = ["agent://a.com", "agent://b.com", "agent://c.com"]
        body = ErasurePropagationStatusBody(
            erasure_id="er-005",
            agent_id="agent://hub.com",
            status="pending",
            records_affected=0,
